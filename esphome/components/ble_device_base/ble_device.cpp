// ble_device.cpp
//
// Implementation of the esp32_ble_tracker compatibility types for any non-ESP32 BLE platform.
...
optional<ESPBLEiBeacon> ESPBLEiBeacon::from_manufacturer_data(const ServiceData &data) {
  ...
  //   [0x02][0x15][16-byte UUID][2-byte major][2-byte minor][1-byte power] = 21 payload bytes
...
const char *ESPBTDevice::address_str_to(char *buf) const {
  // any non-ESP32 BLE platform stores MAC bytes as [0]=LSB … [5]=MSB; display MSB-first.
