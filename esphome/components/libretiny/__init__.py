...
# First LibreTiny release expected to carry the realtek-ambd family (adjust at
# the version bump if the release numbers differently); the guard below
# self-expires once the pinned/requested version reaches it.
_FIRST_AMBD_VERSION = cv.Version(1, 14, 0)


def _check_rtl8720d_framework(config):
