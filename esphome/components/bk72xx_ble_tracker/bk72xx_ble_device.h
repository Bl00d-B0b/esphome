...
// ServiceData, ESPBLEiBeacon, ESPBTDevice, ESPBTDeviceListener) on BK7231N
...
class ESPBTDevice {
 public:
  /// Populate from a raw BK7231N scan result.
...
// so that sensor components compiled with the BK7231N backend can include this
