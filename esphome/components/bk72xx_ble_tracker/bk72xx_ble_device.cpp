...
//
// Implementation of the esp32_ble_tracker compatibility types for the BK72xx family.
...
#define BK72XX_BLE_HAS_MBEDTLS_AES
#endif
...
const char *ESPBTDevice::address_str_to(char *buf) const {
  // The BK72xx report MAC bytes as [0]=LSB … [5]=MSB; display MSB-first.
...
#ifndef BK72XX_BLE_HAS_MBEDTLS_AES
